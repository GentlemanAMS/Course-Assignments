...
unsigned int send_array[DCACHE_SIZE / INT_SIZE] __attribute__ ((aligned(32768)));
...
{
	unsigned int set_index_A0 = strtol(argv[1], NULL, 0);   /* This cache set is used to transfer a 0 to receiver */
	unsigned int set_index_A1 = strtol(argv[2], NULL, 0);   /* This cache set is used to transfer a 1 to receiver */ 
	unsigned int set_index_BO = strtol(argv[3], NULL, 0);   /* This set signals the receiver that the bit sent is at an odd index */
	unsigned int set_index_BE = strtol(argv[4], NULL, 0);   /* This set signals the receiver that the bit sent is at an even index */

	unsigned int A0_0, A0_1, A0_2, A0_3, A0_4, A0_5, A0_6, A0_7;  /* 8 associate cache lines corresponding to set A0 */
	unsigned int A1_0, A1_1, A1_2, A1_3, A1_4, A1_5, A1_6, A1_7;  /* 8 associate cache lines corresponding to set A1 */
	unsigned int BO_0, BO_1, BO_2, BO_3, BO_4, BO_5, BO_6, BO_7;  /* 8 associate cache lines corresponding to set BO */
	unsigned int BE_0, BE_1, BE_2, BE_3, BE_4, BE_5, BE_6, BE_7;  /* 8 associate cache lines corresponding to set B1 */  


	unsigned int send_start = (unsigned int) send_array; /* address of the send_array */
	...
	float time = 0;
	unsigned int data[DATASIZE]={1,0,0,1, 0, 0, 1, 0, 0, 1};       
	unsigned int tA_0 , tA_1 , tA_2, tA_3, tA_4, tA_5, tA_6, tA_7; 
	unsigned int tB_0 , tB_1 , tB_2, tB_3, tB_4, tB_5, tB_6, tB_7; 
