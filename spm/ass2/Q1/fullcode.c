...
#include<stdio.h>
void ByteCpy(unsigned char *dst,  unsigned char *src, int bytelen);
void ByteXor(unsigned char *dst,  unsigned char *a,  unsigned char *b, int bytelen);

unsigned char ClefiaMul2(unsigned char x);
void ClefiaF0Xor(unsigned char *y,  unsigned char *x,  unsigned char *rk);
void ClefiaF1Xor(unsigned char *y,  unsigned char *x,  unsigned char *rk);
void ClefiaGfn4(unsigned char *y,  unsigned char *x,  unsigned char *rk, int r);
void ClefiaGfn8(unsigned char *y,  unsigned char *x,  unsigned char *rk, int r);
void ClefiaGfn4Inv(unsigned char *y,  unsigned char *x,  unsigned char *rk, int r);

void ClefiaDoubleSwap(unsigned char *lk);
void ClefiaConSet(unsigned char *con,  unsigned char *iv, int lk);
void ClefiaKeySet128(unsigned char *rk,  unsigned char *skey);
void ClefiaKeySet192(unsigned char *rk,  unsigned char *skey);
void ClefiaKeySet256(unsigned char *rk,  unsigned char *skey);

int ClefiaKeySet(unsigned char *rk,  unsigned char *skey,  int key_bitlen);
void ClefiaEncrypt(unsigned char *ct,  unsigned char *pt,  unsigned char *rk,  int r);
void ClefiaDecrypt(unsigned char *pt,  unsigned char *ct,  unsigned char *rk,  int r);
...
void ClefiaF0Xor(unsigned char *dst,  unsigned char *src,  unsigned char *rk)
{
...
void ClefiaF1Xor(unsigned char *dst,  unsigned char *src,  unsigned char *rk)
{
  unsigned char x[4], y[4], z[4];
...
void ClefiaKeySet128(unsigned char *rk,  unsigned char *skey)
{
   unsigned char iv[2] = {0x42U, 0x8aU}; /* cubic root of 2 */
  unsigned char lk[16];
...
void ClefiaKeySet192(unsigned char *rk,  unsigned char *skey)
{
   unsigned char iv[2] = {0x71U, 0x37U}; /* cubic root of 3 */
...
void ClefiaKeySet256(unsigned char *rk,  unsigned char *skey)
{
   unsigned char iv[2] = {0xb5, 0xc0U}; /* cubic root of 5 */
  unsigned char lk[32];
