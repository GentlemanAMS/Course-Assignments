...
sed -n '19,23p' "$DIR/${SORT}_250_annotate_output.txt" >> "comparison_diff_arraylength.txt"

echo "\n\nArray Length: 500000" >> "comparison_diff_arraylength.txt"
sed -n '19,23p' "$DIR/${SORT}_500_annotate_output.txt" >> "comparison_diff_arraylength.txt"

echo "\n\nArray Length: 750000" >> "comparison_diff_arraylength.txt"
sed -n '19,23p' "$DIR/${SORT}_750_annotate_output.txt" >> "comparison_diff_arraylength.txt"

echo "\n\nArray Length: 1000000" >> "comparison_diff_arraylength.txt"
sed -n '19,23p' "$DIR/${SORT}_1000_annotate_output.txt" >> "comparison_diff_arraylength.txt"
