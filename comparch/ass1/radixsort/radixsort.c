...
void countsort(long int array[], long int placeholder)
{
    long int output[ARRAY_SIZE];
    int iter;
    long int count[10] = {0};
...
void radixsort(long int array[])
{
    long int maximum = array[0];
    int iter;
